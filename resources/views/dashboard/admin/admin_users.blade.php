    ...
    <div class="mt-10 max-w-screen-xl mx-auto">
        ...
        <div class="">
            ...
            <p class="my-6 text-lg text-gray-500">
                You can initiate user creation by clicking the 
        ...
        <div>
            <!-- Start table -->
            <x-table :entries="$users" :current_page="$current_page"/>
            <!-- End table -->
            ...
            <!-- Update modal -->
            <x-update-entry-model :entries="$users" :current_page="$current_page"/>

            <!-- Delete modal -->
            <x-delete-entry-model :entries="$users" :current_page="$current_page"/>
        </div>
    </div>
