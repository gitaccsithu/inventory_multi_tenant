    ...
    <div class="mt-10 max-w-screen-xl mx-auto">
        ...
        <div class="">
            ...
            <p class="my-6 text-lg text-gray-500">
                You can initiate tenant creation by clicking the 
        ...
        <div>
            <!-- Start table -->
            <x-table :entries="$tenants" :current_page="$current_page"/>
            <!-- End table -->

            {{-- Create new entry model --}}
            <x-create-entry-model :current_page="$current_page" :new_users="$new_users"/>

            <!-- Update modal -->
            <x-update-entry-model :entries="$tenants" :current_page="$current_page"/>

            <!-- Delete modal -->
            <x-delete-entry-model :entries="$tenants" :current_page="$current_page"/>
        </div>
    </div>
